...
def train(opt):
    ...
    if opt.early_stopping_param == 'accuracy':
      ...
      raise Exception('early_stopping_param is neither accuracy, loss or None')
    ...
    while(True):
        ...
        # validation part
        if i > (opt.ignore_x_vals * opt.valInterval) and i % opt.valInterval == 0:
            ...
            with open(f'./saved_models/{opt.experiment_name}/log_train.txt', 'a') as log:
                ...
                if current_patience == 0:
                  print("Stopped the training due to early stopping patience")
                  sys.exit()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--FeatureExtraction', type=str, required=True,
                        help='FeatureExtraction stage. VGG|RCNN|ResNet|ResNet_PyTorch')
    ...
    parser.add_argument('--freeze_FeatureExtraction', action='store_true', help='freeze the feature extraction layer')
    parser.add_argument('--early_stopping_param', type=str, default='None', help='early stopping parameter accuracy|loss')
    parser.add_argument('--early_stopping_patience', type=int, default=10, help='early stopping patience')
    parser.add_argument('--ignore_x_vals', type=int, default=30, help='Number of x first validation to ignore')
